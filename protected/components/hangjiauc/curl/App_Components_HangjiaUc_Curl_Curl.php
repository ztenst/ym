...
**/
class App_Components_HangjiaUc_Curl_Curl {
    ...
    **/
     ...
     *
     * Returns a App_Components_HangjiaUc_Curl_CurlResponse object if the request was successful, false otherwise
     *
     * @param string $url
     * @param array|string $vars
     * @return App_Components_HangjiaUc_Curl_CurlResponse object
    **/
    ...
    **/
     ...
     * @param string $url
     * @param array|string $vars
     * @return App_Components_HangjiaUc_Curl_CurlResponse
    **/
    ...
    **/
     ...
     * @param string $url
     * @param array|string $vars
     * @return App_Components_HangjiaUc_Curl_CurlResponse|boolean
    **/
    ...
    **/
    function request($method, $url, $vars = array()) {
        ...
        if ($response) {
            $response = new App_Components_HangjiaUc_Curl_CurlResponse($response);
        } else {
